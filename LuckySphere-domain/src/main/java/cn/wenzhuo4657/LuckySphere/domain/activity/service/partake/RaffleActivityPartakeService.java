package cn.wenzhuo4657.LuckySphere.domain.activity.service.partake;
...
import cn.wenzhuo4657.LuckySphere.domain.activity.model.valobj.UserRaffleOrderStateVO;
...
//        如果不存在月账户就创建
    ...
    protected UserRaffleOrderEntity buildUserRaffleOrder(String userId, Long activityId, Date currentDate) {
        ...
        userRaffleOrder.setOrderId(RandomOrderIdUtils.getOrderId());
